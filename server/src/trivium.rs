...
fn build_payload(memory: &MemoryRecord) -> Value {
    json!({
        ...
        "actor_account_uid": memory.actor_account_uid,
        "actor_person_uid": memory.actor_person_uid,
        "subject_person_uid": memory.subject_person_uid,
        "source_platform": memory.source_platform,
        "domain_kind": memory.domain_kind.as_str(),
        "domain_key": memory.domain_key,
        "observation_at": memory.observation_at,
