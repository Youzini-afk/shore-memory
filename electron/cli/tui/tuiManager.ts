import { TUI, ProcessTerminal, Container, Text, Editor, Key, matchesKey } from "@mariozechner/pi-tui";
...
export class TuiManager {
    ...
    private async showStatus() {
        ...
        for (const s of services) {
            const color = s.status === 'running' ? theme.success : 
                          s.status === 'error' ? theme.error : theme.dim;
